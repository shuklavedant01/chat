            ...
            <Paper>
              ...
              >
                {menuChildren.map((item, i) => {
                  ...
                  switch (type) {
                    case 'group':
                      return <NavCollapse key={i} title={title} menuChildren={menuChildren} Icon={Icon} />;
                    case 'item':
                      return (
                        <MenuItem
                          key={i}
              ...
              >
                {menuChildren.map((item, i) => {
                  ...
                  switch (type) {
                    case 'group':
                      return (
                        <NavCollapse key={i} title={title} menuChildren={menuChildren} level={level + 1} Icon={Icon} />
                      );
                    case 'item':
                      return (
                        <MenuItem
