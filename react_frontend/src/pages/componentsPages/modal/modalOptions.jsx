      ...
      <Card type="section">
        ...
        <Stack spacing={3} mt={3}>
          <FormControl>
            ...
            <RadioGroup row aria-labelledby="modal type options" value={type} onChange={(e) => setType(e.target.value)}>
          ...
          <FormControl>
            ...
            >
              ...
              <FormControlLabel value="fullScreen" control={<Radio color="primary" />} label="fullScreen" />
            </RadioGroup>
          </FormControl>
          <FormControl>
