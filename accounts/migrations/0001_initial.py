# Generated by Django 5.0.14 on 2025-07-17 09:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username_iv', models.CharField(max_length=32)),
                ...
                ('phone_iv', models.CharField(blank=True, max_length=32, null=True)),
                ('address_hash', models.CharField(blank=True, max_length=128, null=True)),
                ('address_encrypted', models.TextField(blank=True, null=True)),
                ('address_iv', models.CharField(blank=True, max_length=32, null=True)),
