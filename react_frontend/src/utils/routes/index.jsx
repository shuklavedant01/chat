...
const EntryFormPage = withLazyLoadably(lazy(() => import('@/pages/EntryFormPage')));
...
const AdminHomePage = withLazyLoadably(lazy(() => import('@/pages/adminHome')));
const UserHomePage = withLazyLoadably(lazy(() => import('@/pages/userHome')));
const ChatSection = withLazyLoadably(lazy(() => import('@/pages/adminHome/admin/ChatSection/ChatSection')));
const UpdateAccount = withLazyLoadably(lazy(() => import('@/pages/adminHome/admin/UpdateAccount')));
const StaffRoleManagement = withLazyLoadably(lazy(() => import('@/pages/adminHome/admin/StaffRoleManagement')));
const CreateAccounts = withLazyLoadably(lazy(() => import('@/pages/adminHome/admin/Create Account/CreateAccounts')));

function Router() {
  // ...existing code...
  const AdminPanel = withLazyLoadably(lazy(() => import('@/pages/AdminPanel')));
  const Logout = withLazyLoadably(lazy(() => import('@/pages/Logout')));
  return (
    <BrowserRouter>
      <ScrollToTopOnRouteChange>
        <Routes>
          <Route path="/" element={<MinimalLayout />}>
            <Route index element={<LoginSplitPage />} />
            <Route path="pages/">
          ...
          <Route path="/" element={<MainLayout />}>
            ...
            <Route path="admin/">
              ...
              <Route path="staff-role-management" element={<StaffRoleManagement />} />
