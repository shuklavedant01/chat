...
function LoginForm() {
  ...
  console.log('[LoginForm] useUser context:', userContext);
  ...
  const handleSubmit = async (e) => {
    ...
    setIsLoading(true);
    // Simulate successful login and set user context
    const userData = {
      username: 'abcadmin',
      role: 'Admin',
    ...
    console.log('[LoginForm] Calling login with:', userData);
    if (typeof login === 'function') {
      login(userData);
    } else {
      console.error('[LoginForm] login is not a function!', login);
    }
    setTimeout(() => {
      setIsLoading(false);
      navigate('/');
