...
function CardPage() {
  return (
    <>
      ...
      <Typography>variant: &quot;outlinedElevation&quot; | &quot;outlined&quot; | &quot;elevation&quot;</Typography>
      <Typography>
      ...
      <Stack spacing={4} mt={4}>
        <Card>
          <CardContent title='variant="outlinedElevation"' subtitle='Default Card variant is "outlinedElevation"' />
        </Card>
        <Card variant="outlined">
          <CardContent title='variant="outlined"' subtitle="Outlined variant, borders without shadow elevation" />
        </Card>
