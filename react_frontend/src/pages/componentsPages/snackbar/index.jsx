...
function BasicSnackbarSection() {
  ...
  return (
    <Card component="section" type="section">
      ...
      <Stack direction="row" spacing={3}>
        <Button variant="contained" color="success" disableElevation onClick={handleClickVariantIconHide('success')}>
          success
        </Button>
        <Button variant="contained" color="warning" disableElevation onClick={handleClickVariantIconHide('warning')}>
          warning
        </Button>
        <Button variant="contained" color="info" disableElevation onClick={handleClickVariantIconHide('info')}>
          info
        </Button>
        <Button variant="contained" color="error" disableElevation onClick={handleClickVariantIconHide('error')}>
          error
        </Button>
      </Stack>
    </Card>
...
function MuiSnackbarSection() {
  ...
  return (
    <Card component="section" type="section">
      ...
      <Stack direction="row" spacing={3}>
        <Button variant="contained" color="success" disableElevation onClick={handleClickSeverityTitle('success')}>
          success
        </Button>
        <Button variant="contained" color="warning" disableElevation onClick={handleClickSeverityTitle('warning')}>
          warning
        </Button>
      ...
      <Stack direction="row" spacing={3}>
        <Button variant="contained" color="success" disableElevation onClick={handleClickSeverityOutlined('success')}>
          success
        </Button>
        <Button variant="contained" color="warning" disableElevation onClick={handleClickSeverityOutlined('warning')}>
          warning
        </Button>
        <Button variant="contained" color="info" disableElevation onClick={handleClickSeverityOutlined('info')}>
          info
        </Button>
        <Button variant="contained" color="error" disableElevation onClick={handleClickSeverityOutlined('error')}>
          error
        </Button>
      </Stack>
      <Typography variant="h5" mt={5}>
      ...
      <Stack direction="row" spacing={3}>
        <Button variant="contained" color="success" disableElevation onClick={handleClickSeverityFilled('success')}>
          success
        </Button>
        <Button variant="contained" color="warning" disableElevation onClick={handleClickSeverityFilled('warning')}>
          warning
        </Button>
      ...
      <Stack direction="row" spacing={3} flexWrap="wrap">
        <Button variant="contained" color="success" disableElevation onClick={handleClickSeverityAction('success')}>
          success
        </Button>
        <Button variant="contained" color="warning" disableElevation onClick={handleClickSeverityAction('warning')}>
          warning
        </Button>
