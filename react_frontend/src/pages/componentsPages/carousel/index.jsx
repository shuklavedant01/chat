  ...
  return (
    <Card type="none">
        ...
        {data.map((data, i) => (
          <Slider.Slide index={i} key={i}>
            <Box position="relative" maxHeight={500}>
              ...
              >
                Lorem, ipsum dolor sit amet consectetur adipisicing elit. Pariatur culpa quae assumenda quod et saepe
                perspiciatis accusantium at quo tempora!
                {data.label}
              </Typography>
            </Box>
          </Slider.Slide>
      ...
      <MobileStepper
        ...
        backButton={
          <Button size="small" onClick={() => setCounter(activeSlideIndex - 1)} disabled={activeSlideIndex === 0}>
            <KeyboardArrowLeft />
            Back
          </Button>
        }
