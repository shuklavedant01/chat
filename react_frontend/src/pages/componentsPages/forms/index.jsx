      ...
      <Grid container rowSpacing={2} columnSpacing={4}>
        <Grid item xs={12} sm={6} md={4}>
          <MaskedInput
            ...
            placeholderChar="_"
            render={(ref, props) => <TextField label="Text-Mask" required inputRef={ref} {...props} fullWidth />}
          />
        </Grid>
        ...
        <Grid item xs={6} sm={4} md={4}>
          <InputMask mask="(999) 999-9999" value={telInput} onChange={(e) => setTelInput(e.target.value)}>
            {(inputProps) => <TextField {...inputProps} type="tel" fullWidth placeholder="(999) 999-9999" />}
          </InputMask>
        </Grid>
        <Grid item xs={6} sm={4} md={4}>
        ...
        <Grid item xs={6} sm={4} md={4}>
          <InputMask mask={'+4\\ 999-99-9999'} value={telInput4} onChange={(e) => setTelInput4(e.target.value)}>
            {(inputProps) => <TextField {...inputProps} type="tel" fullWidth placeholder="+4 999-99-9999" />}
          </InputMask>
        </Grid>
      </Grid>
    </Card>
